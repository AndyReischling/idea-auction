// scripts/create-100-bots-simple.js
...
async function create100Bots() {
  ...
  try {
    ...
    console.log(`\n🔍 To query bots from Firestore:`);
    console.log(`   - Use collectionGroup(db, 'bots') to get all bots`);
    console.log(`   - Use collection(db, 'autonomous-bots', '${parentDocId}', 'bots') for this specific batch`);
