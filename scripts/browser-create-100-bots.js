// scripts/browser-create-100-bots.js
// Run this in your browser console or import into your admin page
...
async function create100Bots() {
  ...
  // Import Firebase (assuming it's already initialized in your app)
...
if (typeof window !== 'undefined') {
  window.create100Bots = create100Bots;
}

// Example usage:
// create100Bots().then(result => console.log('Done!', result)); 